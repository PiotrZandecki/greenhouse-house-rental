...
export const reviews: Review[] = [
  {
    ...
    text: {
      ...
      ceb: "Beautifully designed, peaceful ug sayon kaayo i-book. Private ang feeling sa place from the first moment.",
      ...
      de: "Wunderschön gestaltet, ruhig und sehr einfach zu buchen. Der Ort fühlte sich vom ersten Moment an privat an.",
  ...
  },
  {
    ...
    text: {
      ...
      ceb: "Ang gallery nakatabang namo pili dayon. Klaro tanan, especially ang amenities ug WhatsApp contact.",
      ...
      de: "Die Galerie half uns, schnell zu wählen. Alles war klar, besonders die Ausstattung und der WhatsApp-Kontakt.",
  ...
  },
  {
    ...
    text: {
      ...
      ceb: "Premium-feeling stay with very friendly direct booking experience.",
      ...
      de: "Ein Aufenthalt mit Premium-Gefühl und einer sehr angenehmen direkten Buchungserfahrung.",
